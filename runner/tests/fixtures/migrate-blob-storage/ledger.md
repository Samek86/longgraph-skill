...
Write set: migrations/drop_blob.sql (owner-only; not applied while OB-001 is open)
Context: C-01
Verify: n/a — owner-blocked on OB-001
Done when: owner answers A or B on OB-001; then reversible migration drops the blob column
