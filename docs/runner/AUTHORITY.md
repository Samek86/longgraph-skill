# Runner authority (Phase 0 / 1a / 1b)
...
| [`RUNNER-INVARIANTS.md`](RUNNER-INVARIANTS.md) | A* rules and the Phase ≤1b CI list |
| [`EXPANSION-PLAN.md`](EXPANSION-PLAN.md) | Phase 0 / 1a / 1b extract of EXPANSION-PLAN-v3.3 (golden table, Host/MockHost, PromptOnlyHost, retry) |
...
parser), Phase 1a (MockHost MVP), and Phase 1b (PromptOnlyHost dual `/loop`
emit). Later phases (1c+) are out of scope and must not be invented in this tree.
